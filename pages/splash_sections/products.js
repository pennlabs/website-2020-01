  ...
  <section className="section" style={{backgroundColor: "#209CEE", color:"azure"}}>
    ...
    <br/>
      <div className="columns is-multiline">
        ...
        <ProductCard href="https://penncoursesearch.com/" img="/static/img/PCP.png" imgClassName="image is-64x64" title="Penn Course Search" desc="Penn Course Search combines course rating insights with an easy-to-use mock scheduling tool. Choose the best schedule for your semester, with at-a-glance schedule insights and comparisons coming soon!"  />
