  ...
  <div>
    ...
    >
      <div className="container">
        ...
        <h2
          className="subtitle has-text-grey-lighter"
          style={{ fontSize: '2rem' }}
        >
          the apps that better your life at{' '}
          <span className="has-text-weight-bold">Penn</span>.
        </h2>
        <br />
        <div className="columns is-multiline">
          ...
          />
          <ProductCard
            href="http://pennbasics.com/"
            img="/static/img/PennBasics.png"
            imgClassName="image is-64x64"
            title="Penn Basics"
            desc="Penn Basics aims to be your the one-stop spot for the basics of living at Penn. It aggregates essential data on dining, laundry, and study spaces. To be launched in Fall 2019!"
          />
          <ProductCard
          ...
          />
          <ProductCard
            href="https://itunes.apple.com/us/app/penn-mobile/id944829399?mt=8"
